    ...
    toast.promise(
      (async () => {
        try {
          ...
          setPricePredictionHistory((prevHistory) => [
            ...prevHistory,
            { ...formData, predictedPrice: response.data.predicted_price },
          ]);
      ...
      {
        loading: "Predicting price...",
        success: "Price predicted successfully!",
